...
//목표) 원하는 영화명(토이스토리)을 검색하고 검색하기 버튼을 누르면 영화명, 개봉일이 콘솔일이 콘솔에 출력
...
//변수, 함수명 참고) 노트북 모델명 노트북 크기, 노트북검색
const laptop_name = '삼성 노트북 S-107 live';
const laptop_size = '15인치';
function laptop_search(){
    console.log(laptop_name);
    console.log(laptop_sieze);
}
//목표)여행검색하기 클릭 시 여행지/가격/특산물 정보 콘솔출력
//강릉/20만원/감자빵
const travel_area = '부산';
let travel_price = '50만원';
let travel_food = '생선구이';
